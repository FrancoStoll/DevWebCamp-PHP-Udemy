...
<section class="resumen">
    <div class="resumen__grid">
        <div class="resumen__bloque" <?php aos_animation(); ?>>
...
<section class="boletos">
    ...
    <div <?php aos_animation() ?> class="boletos__grid"">
    ...
    <div class="boleto__enlace-contenedor">
        <a href="/paquetes" class="boleto__enlace">Mas información sobre los paquetes</a>
    </div>
</section>